...
.DESCRIPTION
 ...
 Usage:
    Get-ADComputerLAPS.ps1 -ComputerName COMPUTER1
    Get-ADComputerLAPS.ps1 COMPUTER1, COMPUTER2
...
.EXAMPLE
   Get-ADComputerLAPS -ComputerName COMPUTER1
...
.EXAMPLE
   Get-ADComputerLAPS COMPUTER1, COMPUTER2
...
.NOTES
   File Name  : Get-ADComputerLAPS.ps1
   Version    : 2.1912
